...
@Component({
  ...
  templateUrl: './matrizmarcologico2creada.component.html',
  styleUrls: ['./matrizmarcologico2creada.component.css']
})
export class Matrizmarcologico2creadaComponent {
  ...
  otraideaPDF(): void{
    ...
    html2pdf()
      ...
      .set({
        ...
        filename: (`${new Date().toISOString()}Matriz-marco-logico2.pdf`),
