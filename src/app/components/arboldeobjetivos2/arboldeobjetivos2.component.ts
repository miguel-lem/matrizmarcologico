...
@Component({
  selector: 'app-arboldeobjetivos2',
  templateUrl: './arboldeobjetivos2.component.html',
  styleUrls: ['./arboldeobjetivos2.component.css']
})
export class Arboldeobjetivos2Component {
  ...
  regresarProyectos(): void {
    //control de la ruta de navegacion
